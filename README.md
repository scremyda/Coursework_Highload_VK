...
Средний размер хранилища на бронирование - 0.5 КБ, количество броней за последние 5 лет в среднем 4475 млн. Размер хранилища на брони
...
Также будем использовать ElasticSearch, тк он прекрасно ориентирован на работу с документами. После индексации мы можем выполнять поиск, сортировать, фильтровать данные.
- `accommodation`
...
![Схема Booking](https://github.com/scremyda/Coursework_Highload_VK/assets/63557586/071f634c-c2d0-472d-adad-445515ca9db8)
...
Одно изображение в среднем 10 Кб.
...
Примем пиковый(x1.5) RPS на 1 ЦОД как пиковый RPS на регион - это обеспечит надежность системы при выходе из строя одного из ДЦ, а также обеспечит запасом производительности на ближайшее будущее.

Также учтем, что сервис бронирования является тяжелой логикой.

| Сервис    | Пиковый RPS | CPU  |  RAM   | Disk |
|-----------|:------------|:----:|:------:|:------:|
| Search      | 41 000       |  410  |  41 Гб  |  -  | 
| Accomodation   | 180 000  | 1800 |  180 Гб  |  -  |
| Review | 89 000      | 890 | 89 Гб |   -  |
| Auth      | 1 500       | 16  | 2 Гб  |   -  |
| Book   | 3 000      | 300 | 30 Гб |   -  |
| User     | 1 500      | 16 | 2 Гб  |   -  |
| Redis       | 275 000    |  320   | 10 Tб | 10 Tб  |
| PostgreSQL    |  273 000   | 1400  | 1 Tб | 10 Tб |
...
| --------- | ------- | ------------------------------------ |-------- | -------- |-------- | -------------------- |
| kube node | own     | 2U/8xAMD EPYC 9454/8x128GB/2xNVMe256GB/2x25Gb/s | 48 | 11 | $58 000 | $5000 |
| Redis     | own     | 1U/4xAMD EPYC 7552/64x256GB/1xNVMe16T/1x10Gb/s  | 48 | 2 | $31 000 | $2500 |
| PostgreSQL  | own   | 2U/8xAMD EPYC 9454/16x128GB/1xNVMe16T/1x25Gb/s    | 48 | 4 | $59 000 | $5000 |
...
| Сервис    | Пиковый RPS | CPU  |  RAM   | Disk |
|-----------|:------------|:----:|:------:|:------:|
| Search      | 24 000    |  240  |  24 Гб  |   -  |
| Accomodation   | 105 000  | 1050 |  105 Гб  |  -  |
| Review | 53 000      | 530 | 53 Гб |   -  |
| Auth      | 750   | 8  | 2 Гб  |   -  |
| Book   | 1 500      | 160 | 16 Гб |   -  |
| User     | 750     | 8 | 2 Гб  |  -  |
| Redis       | 161 000    |  320   | 10 Tб | 10 Tб    |
| PostgreSQL    |  159 000   | 1400  | 1 Tб | 10 Tб |
...
| Сервис    | Хостинг | Конфигурация                        | Cores | Count | Покупка | Аренда/Амортизация |
| --------- | ------- | ------------------------------------ |-------- | -------- |-------- | -------------------- |
| kube node | own     | 2U/8xAMD EPYC 9454/8x128GB/2xNVMe256GB/2x25Gb/s | 48 | 7 | $58 000 | $5000 |
| Redis     | own     | 1U/4xAMD EPYC 7552/64x256GB/1xNVMe16T/1x10Gb/s  | 48 | 2 | $31 000 | $2500 |
| PostgreSQL  | own   | 2U/8xAMD EPYC 9454/16x128GB/1xNVMe16T/1x25Gb/s    | 48 | 4 | $59 000 | $5000 |
...
| Сервис    | Пиковый RPS | CPU  |  RAM   | Disk |
|-----------|:------------|:----:|:------:|:------:|
| Search      | 38 000    |  380  |  38 Гб  |  -  |
| Accomodation   | 164 000  | 1640 |  164 Гб  |   -  |
| Review | 82 000      | 820 | 82 Гб |   -  |
| Auth      | 1 500   | 15  | 2 Гб  |   -  |
| Book   | 3 000      | 300 | 30 Гб |   -  |
| User     | 1 500     | 15 | 2 Гб  |  -  |
| Redis       | 290 000    |  320   | 10 Tб | 10 Tб    |
| PostgreSQL    |  288 000   | 1400  | 1 Tб | 10 Tб |
...
| Сервис    | Хостинг | Конфигурация                         | Cores | Count | Покупка | Аренда/Амортизация |
| --------- | ------- | ------------------------------------ |-------- | -------- |-------- | -------------------- |
| kube node | own     | 2U/8xAMD EPYC 9454/8x128GB/2xNVMe256GB/2x25Gb/s | 48 | 10 | $58 000 | $5000 |
| Redis     | own     | 1U/4xAMD EPYC 7552/64x256GB/1xNVMe16T/1x10Gb/s  | 48 | 2 | $31 000 | $2500 |
| PostgreSQL  | own   | 2U/8xAMD EPYC 9454/16x128GB/1xNVMe16T/1x25Gb/s    | 48 | 4 | $59 000 | $5000 |
...
| Сервис    | Пиковый RPS | CPU  |  RAM   | Disk | 
|-----------|:------------|:----:|:------:|:------:|
| Search      | 34 000    |  340  |  34 Гб  |   -  |
| Accomodation   | 141 000  | 1410 |  141 Гб  |  -  |
| Review | 71 000      | 710 | 71 Гб |   -  |
| Auth      | 1 500   | 10  | 2 Гб  |   -  |
| Book   | 3 000      | 300 | 30 Гб |   -  |
| User     | 1 500     | 10 | 2 Гб  |  -  |
| Redis       | 252 000    |  320   | 10 Tб | 10 Tб    |
| PostgreSQL    |  250 000   | 1400  | 1 Tб | 10 Tб |
...
| Сервис    | Хостинг | Конфигурация                         | Cores | Count | Покупка | Аренда/Амортизация |
| --------- | ------- | ------------------------------------ |-------- | -------- |-------- | -------------------- |
| kube node | own     | 2U/8xAMD EPYC 9454/8x128GB/1xNVMe256GB/2x25Gb/s | 48 | 9 | $58 000 | $5000 | 
| Redis     | own     | 1U/4xAMD EPYC 7552/64x256GB/1xNVMe16T/1x10Gb/s  | 48 | 2  | $31 000 | $2500 |
| PostgreSQL  | own   | 2U/8xAMD EPYC 9454/16x128GB/1xNVMe16T/1x25Gb/s   | 48 | 4  | $59 000 | $5000 |
...
| PostgreSQL    |  70 000   | 700  | 350 Гб | 3 Tб |
...
| Сервис    | Хостинг | Конфигурация                         | Cores | Count | Покупка | Аренда/Амортизация |
| --------- | ------- | ------------------------------------ |-------- | -------- |-------- | -------------------- |
| kube node | own     | 2U/8xAMD EPYC 9454/8x64GB/1xNVMe128GB/2x25Gb/s | 48 | 3 | $57 000 | $5000 |
| Redis     | own     | 1U/4xAMD EPYC 7552/16x256GB/1xNVMe4T/1x10Gb/s   | 48 | 1 | $27 000 | $2500 |
| PostgreSQL  | own   | 2U/8xAMD EPYC 9454/8x128GB/1xNVMe4T/1x25Gb/s    | 48 | 3 | $58 000 | $5000 |
