...
| Redis             |           Хранение пользовательских сессий            |                               Легко масштабируется, большое комьюнити, очень быстрый, проще в обслуживании, чем аналоги.            |
| Prometheus        |          Хранилище метрик                             |                              В отличии от конкурентов сам берёт нужную ему информацию с серверов и устройств.                       |
| Amazon S3         |         Хранилище картинок                            |                                  Простое взаимодействие, лучший в отрасли показатели производительности, масштабируемости.          |
