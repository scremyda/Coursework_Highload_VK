...
Также учтем, что сервис бронирования является тяжелой логикой и примем соотношение ядер к RPS как 1 к 10.
...
| Book   | 3 000      | 300 | 3 Гб |   -  |
| User     | 1 500      | 16 | 2 Гб  |   -  |
| Redis       | 316 000    |  320   | 7 Tб | 7 Tб  |
| PostgreSQL    |  316 000   | 1400  | 700 Гб | 7 Tб |
