...
| Отказоустойчивая архитектура                       |  Резервирование: Ресурсов, физических компонентов, репликация бд, независимые геораспределенные ДЦ.  <br> <br> Failover policy: Rate limiter клиентских запросов по IP, Retry только от frontend. <br> <br> Gracefull shutdown: Обработка висящих запросов при остановке сервиса. <br> <br> Graceful degradation: Остаемся user-friendly при негативных сценариях. |
| Асинхронные паттерны | 2PC (two phase commit): реализация распределенных транзакций с помощью двух этапного коммита.
...
Примем пиковый коэффициент за 1.3 из-за 2 ЦОДов в данном регионе и примем за пиковый RPS (запросы на регион) * 1.3.

| Сервис    | Пиковый RPS | CPU  |  RAM   | Disk |
|-----------|:------------|:----:|:------:|:------:|
| Search      | 35 000       |  350  |  35 Гб  |  -  | 
| Accomodation   | 152 000  | 1520 |  152 Гб  |  -  |
| Review | 76 000      | 760 | 76 Гб |   -  |
| Auth      | 1 300       | 14  | 2 Гб  |   -  |
| Book   | 2 000      | 20 | 4 Гб |   -  |
| User     | 1 300      | 14 | 2 Гб  |   -  |
| Redis       | 268 000    |  320   | 7 Tб | 7 Tб    |
| PostgreSQL    |  268 000   | 1400  | 700 Гб | 7 Tб |


Конфигурация машин. Так как все сервисы, кроме СУБД, живут в Kubernetes, для них можно закупать одинаковые машины.

| Сервис    | Хостинг | Конфигурация                         | 
| --------- | ------- | ------------------------------------ | 
| kube node | own     | 2x6430/16x128GB/1xNVMe256GB/2x25Gb/s |
| Redis     | own     | 1x3408U/32x256GB/1xNVMe8T/1x10Gb/s   |
| PostgreSQL  | own   | 2x6430/16x128GB/1xNVMe8T/1x25Gb/s    | 
...
| Сервис    | Пиковый RPS | CPU  |  RAM   | Disk |
|-----------|:------------|:----:|:------:|:------:|
| Search      | 21 000    |  210  |  21 Гб  |   -  |
| Accomodation   | 91 000  | 910 |  91 Гб  |  -  |
| Review | 45 500      | 455 | 46 Гб |   -  |
| Auth      | 1 000   | 10  | 2 Гб  |   -  |
| Book   | 1 600      | 16 | 4 Гб |   -  |
| User     | 1 000     | 10 | 2 Гб  |  -  |
| Redis       | 161 000    |  320   | 7 Tб | 7 Tб    |
| PostgreSQL    |  161 000   | 1400  | 700 Гб | 7 Tб |
...
Примем пиковый коэффициент за 1 из-за 3 ЦОДов в данном регионе и примем за пиковый RPS запросы на регион.
...
| Book   | 3 000      | 30 | 4 Гб |   -  |
| User     | 1 600     | 16 | 2 Гб  |  -  |
| Redis       | 290 000    |  320   | 7 Tб | 7 Tб    |
| PostgreSQL    |  290 000   | 1400  | 700 Гб | 7 Tб |
...
| Сервис    | Пиковый RPS | CPU  |  RAM   | Disk |
|-----------|:------------|:----:|:------:|:------:|
| Search      | 28 600    |  286  |  30 Гб  |   -  |
| Accomodation   | 120 000  | 1200 |  120 Гб  |  -  |
| Review | 60 000      | 600 | 60 Гб |   -  |
| Auth      | 1 300   | 14  | 2 Гб  |   -  |
| Book   | 2 000      | 20 | 4 Гб |   -  |
| User     | 1 300     | 14 | 2 Гб  |  -  |
| Redis       | 213 000    |  320   | 7 Tб | 7 Tб    |
| PostgreSQL    |  213 000   | 1400  | 700 Гб | 7 Tб |
...
| Сервис    | Хостинг | Конфигурация                         | 
| --------- | ------- | ------------------------------------ | 
| kube node | own     | 2x6430/8x64GB/1xNVMe128GB/2x25Gb/s |
| Redis     | own     | 1x3408U/16x256GB/1xNVMe4T/1x10Gb/s   |
| PostgreSQL  | own   | 2x6430/8x128GB/1xNVMe4T/1x25Gb/s    | 
