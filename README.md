...
Примем пиковый коэффициент за 1.3 из-за 2 ЦОДов в данном регионе и примем за пиковый RPS (все запросы на регион) * 1.3.
...
Примем пиковый коэффициент за 1 из-за 3 ЦОДов в данном регионе и примем за пиковый RPS все запросы на регион.
